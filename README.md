...
| **[docs/MODULES.md](docs/MODULES.md)** | "Where do I go to change X?" Code map, the shared layers, device lifecycle rules, common tasks. |
...
python tests/test_tree_shape.py    # shortest-route depth and pre-order rows
